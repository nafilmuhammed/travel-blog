	...
	<div class="box-form">
		<div class="left">
			<div class="overlay">
				...
				<h3>share your travel moments with "escape to !!"</h3>
				<p style="color:black">The journey of a thousand miles begins with a single step !!</p>
			</div>
		</div>
		<div class="right">
			<h5>Login </h5>
			<p>Don't have an account? <a href="http://localhost/php/mypro/partials/registeration.php.">Create Your Account in travel blog</a> it takes less than a minute</p>
